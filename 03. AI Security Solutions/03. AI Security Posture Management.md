...
# Azure Defender for Cloud로 생성형 AI 워크로드 보호하기
...
<img width="851" height="604" alt="MDC4" src="https://github.com/user-attachments/assets/7345d136-b95a-48f9-816b-ec9af202aa61" />

---

## 📊 참고 스크린샷

Defender for Cloud에서 제공하는 **AI 자산 요약 대시보드**:
...
(※ 실제 포털 스크린샷은 [Microsoft 공식 문서](https://learn.microsoft.com/en-us/azure/defender-for-cloud/ai-security-posture)를 참고)
